    ...
    <SafeAreaView style={s.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.avatarSection}>
          ...
          <View style={s.badge}>
            <Icone nome="tesoura" tamanho={16} cor={theme.colors.primary} decorativo />
            <Text style={s.badgeText}>Barbeiro</Text>
          </View>
        </View>
        ...
        <View style={s.group}>
          ...
          >
            <View style={s.itemIcon}>
              <Icone nome="senha" tamanho={20} cor={theme.colors.text} decorativo />
            </View>
        ...
        <View style={s.group}>
          {(['system', 'dark', 'light'] as const).map((mode) => {
            // Os emojis originais de "automático" e "escuro" caem no mesmo
            // ícone do mapa de substituição (`tema-escuro`) — perda de
            // distinção visual documentada no relatório da Fase 1.
            ...
            return (
              ...
              >
                <View style={s.itemIcon}>
                  <Icone nome={icones[mode]} tamanho={20} cor={theme.colors.text} decorativo />
                </View>
